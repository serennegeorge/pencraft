<x-mylayouts.layout-dashboard-default>
    ...
    <div class="card1">
        <div class="card-body1">
            ...
            <form action="{{ route('dashboard.writings.update', ['writing' => $writing->id]) }}" method="POST"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title" value="{{ $writing->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" name="description"
                        id="description">{{ $writing->description }}</textarea>
                </div>
